...
public class ProductRepositoryTests {
	...
	public void testGetInStockProducts() {
		...
		Long productIn = repo.countInStockProducts();
		Long productOut = repo.countOutStockProducts();
		System.out.println(productIn);
		System.out.println(productOut);
		
		assertThat(productOut).isNotNull();
	}
	...
	public void testUpdateProduct() {
		...
		assertThat(updatedProduct.getPrice()).isGreaterThan(999);
	}
